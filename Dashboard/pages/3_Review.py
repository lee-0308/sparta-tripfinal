...
df_c1 = pd.read_csv(DATA_DIR / "city_type_1.csv")
df_c2 = pd.read_csv(DATA_DIR / "city_type_2.csv")
df_c3 = pd.read_csv(DATA_DIR / "city_type_3.csv")
df_c4 = pd.read_csv(DATA_DIR / "city_type_4.csv")
df_summary = pd.read_csv(DATA_DIR / "cluster_sentiment_summary.csv")
df_count = pd.read_csv(DATA_DIR / "cluster_spot_counts.csv")
